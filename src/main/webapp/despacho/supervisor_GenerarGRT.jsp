				...
				<div  class="tabs_cont">
					<form id="form_1" action="" method="post">
                     ...
                     <!-------------------DATOS DE VEHICULO (GRILLA)----------------> 
                    	<div style="float:left;font-size:15px;font-weight:800;color:#439DEB;text-decoration:underline;">Generar GRT</div>
                        <div style="margin-left:-100px;padding-top:45px;"> 
                        	<div style="margin-left:-100px" class="wrapper"><input type="text" class="input">C&oacute;digo de Lista:</div></br>   
                        	 <div style="float:right;margin-right:100px;"><a href="#" class="button" onclick="document.getElementById('form_1').submit()">Buscar</a></div>
                      		<div style="padding-top:35px;margin-left:80px;">
                        	<table width="500" border="1" cellspacing="0" bordercolor="#EEEEEE">
                             ...
                             <div style="float:right;margin-right:80px;"><a href="#" class="button2" onclick="document.getElementById('form_1').submit()">Generar GRT</a></div></br></br></br>
                        </div>  
