...
<article class="col18">
                ...
                <ul class="tabs2s">
					<li style="width:450px;margin-left:0px;" ><a href="despachador_RegistrarIngresoEncomiendaDespacho.html">Registrar Ingreso de Encomienda a Despacho</a></li>
                     <li style="width:210px;margin-left:0px;"><a href="#" class="active">Actualizar estado</a></li>   
